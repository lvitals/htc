/*
 * =============================================================================
 * main.c -- Um Showcase da Linguagem C (Versão ANSI C)
 * =============================================================================
 * Adaptado para o padrão ANSI C (C89/C90)
 * =============================================================================
 */
...
void demonstrate_variables_and_types(void) {
    ...
    char char_var = 'C';
    BOOL bool_var = TRUE;
    /* const removido para máxima compatibilidade */
    float PI = 3.14159f;
...
void demonstrate_operators(void) {
    int a = 10, b = 3;
    int x = 0xA; /* 10 em hexadecimal */
    int y = 0xC; /* 12 em hexadecimal */
    BOOL cond;
    char *result_str;
