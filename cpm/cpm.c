...
void io_output(int add, int data)
{
	...
	ori128:
		if (orion128 == FALSE)
		{ /* Switch to Orion128 mode and init F800 ROM area */
			orion128 = TRUE;
			p = ROM_ORG;
			for (i = 0; i < ROM_CNT; i++)
			{
...
void help( void)
{
    fprintf( stderr, "CPM" APPEXT " -- CP/M-80 program for " APPTARGET " v" APPVERSION "\n"
